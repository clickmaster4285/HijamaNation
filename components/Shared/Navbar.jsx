  ...
  return (
    <>
      ...
      >
        ...
        {/* Desktop CTA Buttons - Order: All Courses → Apply Now → Login */}
        <div className="hidden md:flex items-center gap-4">
          {/* All Courses Button - Links to /all-courses */}
          <Link
            href="/all-courses"
            className="text-green-400 font-medium px-4 py-2 rounded-full border border-green-400 hover:bg-green-400/10 transition-all duration-200 whitespace-nowrap"
          >
            All Courses
          </Link>
          ...
          <Link
            href="/apply"
            className="bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-5 py-2 rounded-full transition-colors shadow-lg shadow-green-600/30 whitespace-nowrap"
          >
            Apply Now
          </Link>
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-gray-900/95 backdrop-blur-md py-4 px-8 max-h-[80vh] overflow-y-auto">
            <div className="flex flex-col gap-3">
                ...
                <div key={index}>
                  {item.subItems && item.subItems.length > 0 ? (
                    <>
                      ...
                      <div className="ml-3 border-l-2 border-green-500 pl-3 flex flex-col gap-2 mt-2">
                        {item.subItems.map((sub, idx) => (
                          <Link
                            key={idx}
                            href={sub.href}
              ...
              {/* Mobile Menu CTA Buttons - Order: All Courses → Apply Now → Login */}
              <Link
                href="/all-courses"
                className="text-green-400 text-sm font-medium border border-green-400 px-4 py-2 rounded-full text-center hover:bg-green-400/10 transition-colors"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                All Courses
              </Link>
              ...
              <Link
                href="/apply"
                className="bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-5 py-2.5 rounded-full text-center transition-colors shadow-lg shadow-green-600/30"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Apply Now
              </Link>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-1">
                ...
                <Link 
                  href="/book-treatment" 
                  className="border border-green-400 text-green-400 hover:bg-green-400/10 text-sm font-semibold px-5 py-2.5 rounded-full text-center transition-colors"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Book Treatment
                </Link>
