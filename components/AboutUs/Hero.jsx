...
export default function Hero() {
  ...
  return (
    <section className="about-hero relative overflow-hidden pt-36 md:pt-44 lg:pt-52 pb-14 md:pb-20 bg-green-950 px-6 md:px-12 lg:px-20">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/15 border border-white/25 rounded-lg px-4 py-2.5 text-white placeholder-white/50 text-sm outline-none focus:border-[#1c7c47]/60 focus:bg-white/20 transition-colors font-sans"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white/15 border border-white/25 rounded-lg px-4 py-2.5 text-white placeholder-white/50 text-sm outline-none focus:border-[#1c7c47]/60 focus:bg-white/20 transition-colors resize-none font-sans"
              />
            </div>
      ...
      {/* ─── WhatsApp floating button – no float, only ping ─── */}
      <a
