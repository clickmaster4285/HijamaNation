...
export const blogPosts = [
  // ============================================================
  // BLOG 1 – Complete Guide (with custom meta)
  // ============================================================
  {
    id: 1,
    slug: 'what-is-hijama',
    ...
    content: `
      ...
      <h2>What Is Hijama?</h2>
      <p>Hijama is a form of Prophetic medicine in which a practitioner applies suction cups to the skin and makes small, superficial incisions to draw out stagnant blood from specific points on the body. It is also known as <strong>wet cupping</strong>, and is practised both as a traditional Sunnah‑based remedy and, increasingly, as a complementary wellness treatment supported by modern clinical hygiene standards.</p>

      <h3>Hijama vs. Cupping Therapy</h3>
      <p>It differs from dry cupping, which uses suction alone with no incisions, and from general cupping therapy, a broader category that includes both methods across several cultures.</p>
      <table>
        <thead>
          <tr><th></th><th>Dry Cupping</th><th>Hijama (Wet Cupping)</th></tr>
        </thead>
        <tbody>
          <tr><td><strong>Method</strong></td><td>Suction only</td><td>Suction + superficial incisions</td></tr>
          <tr><td><strong>Blood drawn</strong></td><td>No</td><td>Yes, in small quantities.</td></tr>
          <tr><td><strong>Typical goal</strong></td><td>Muscle tension, circulation</td><td>Traditional detoxification, pain relief, Sunnah practice</td></tr>
          <tr><td><strong>Training required</strong></td><td>Basic</td><td>Advanced, including hygiene and bloodborne pathogen protocols</td></tr>
        </tbody>
      </table>

      <h2>How Hijama Is Performed</h2>
      <p>A typical session follows a structured process:</p>
      <ul>
        <li><strong>Screening and Consultation</strong> – A practitioner checks for contraindications such as pregnancy, anaemia, bleeding disorders, or blood‑thinning medication.</li>
        <li><strong>Cup Placement</strong> – Sterile cups are applied to specific points on the body, often corresponding to traditional Sunnah points, and left to create suction.</li>
        <li><strong>Superficial Incisions</strong> – Small, shallow scratches are made once the skin has been drawn up.</li>
        <li><strong>Blood Drawing</strong> – A small, controlled amount of blood is released into the cup.</li>
        <li><strong>Aftercare</strong> – The area is cleaned and dressed, and the client is given guidance on rest and wound care.</li>
      </ul>
      <p>The amount of blood drawn is small and varies by practitioner and treatment area  it is not comparable to blood donation.</p>

      <h2>Benefits of Hijama</h2>
      <p>Claimed benefits fall into two categories, and a responsible source should separate them clearly.</p>
      <h3>Traditionally Reported Benefits</h3>
      <p>Pain relief, improved circulation, reduced fatigue, general wellbeing, and spiritual reward through Sunnah practice.</p>
      <h3>Areas With Some Scientific Interest</h3>
      <p>Limited studies have explored cupping for musculoskeletal pain and certain inflammatory markers, though evidence remains preliminary and mixed. Hijama should not be presented as a guaranteed cure for any condition.</p>
      <p>Common reasons people seek Hijama include chronic pain, migraines, fatigue, stress, and sports‑related injuries, alongside religious motivation.</p>

      <h2>Risks and Who Should Avoid Hijama</h2>
      <p>When performed by an untrained or unhygienic practitioner, Hijama carries risks including infection, bruising, burns, and  in poor‑hygiene settings  bloodborne disease transmission. This is why sterilised, single‑use equipment and a trained practitioner are essential.</p>
      <h3>Hijama Is Generally Not Recommended For</h3>
      <ul>
        <li>Pregnant women</li>
        <li>People with anaemia or bleeding disorders</li>
        <li>Those on blood‑thinning medication</li>
        <li>People with uncontrolled diabetes or certain heart conditions</li>
        <li>Anyone with an active skin infection at the treatment site</li>
      </ul>
      <p>Anyone with a pre‑existing medical condition should consult a doctor before booking treatment.</p>

      <h2>Hijama in Islam</h2>
      <p>Hijama holds a significant place in Islamic tradition as part of Prophetic medicine (Tibb an‑Nabawi). It is associated with specific Sunnah days  traditionally the 17th, 19th, and 21st of the Islamic lunar month  and with defined Sunnah points on the body. For many practitioners and clients, Hijama is not only a physical treatment but also an act of reviving a prophetic tradition with intention and care.</p>
      <p>A responsible approach keeps the religious and medical framing distinct: Sunnah timing and points are a matter of tradition and personal practice, while safety and suitability for treatment are medical questions that deserve their own honest answers.</p>

      <h2>Your Path With Hijama Nation</h2>
      <p>Understanding what Hijama is naturally leads to one of two questions: do you want to learn it or experience it? Hijama Nation supports both paths.</p>
      <h3>Learn Hijama: Our Certification Course</h3>
      <p>For those who want to train as a practitioner, our Hijama course combines Sunnah‑based teaching with modern clinical standards  covering anatomy, hygiene and infection control, cup placement, contraindications, and aftercare, alongside the ethical and spiritual foundations of the practice.</p>
      <ul>
        <li>Structured, beginner‑friendly curriculum delivered online with lifetime access</li>
        <li>Separate certification pathways for female and male learners</li>
        <li>Practical training and assessment before certification is awarded</li>
        <li>Suitable for beginners, wellness practitioners, healthcare professionals, and those seeking a Sunnah‑based, halal income path</li>
        <li>Ongoing student support from enrolment through to practice</li>
      </ul>
      <p><a href="/hijama-course">Explore the Hijama Course →</a></p>
      <h3>Book Hijama Cupping Therapy</h3>
      <p>For those who want to experience Hijama as a client, treatment is delivered with a clear emphasis on screening, hygiene, and aftercare rather than as a promised cure.</p>
      <ul>
        <li>Pre‑treatment screening and consultation to check suitability</li>
        <li>Guided cupping performed by trained, certified practitioners</li>
        <li>Sterile, single‑use equipment throughout</li>
        <li>Aftercare guidance and follow‑up support</li>
        <li>Clear communication about who should seek medical advice before booking</li>
      </ul>
      <p><a href="/book-treatment">Book Hijama Treatment →</a></p>

      <h2>Frequently Asked Questions</h2>
      <h3>What is Hijama done for?</h3>
      <p>People seek Hijama for pain relief, circulation, fatigue, general well‑being, and religious/spiritual reasons connected to Sunnah practices.</p>
      <h3>Why do Muslims do hijama?</h3>
      <p>Hijama is part of Prophetic medicine, practised on specific Sunnah days as a tradition attributed to the Prophet ﷺ, combining physical care with spiritual intention.</p>
      <h3>Is Hijama painful?</h3>
      <p>Most clients describe mild discomfort  a pulling sensation from the suction and a brief scratching sensation from the incisions, followed by light soreness similar to a bruise.</p>
      <h3>How much blood is lost during Hijama?</h3>
      <p>Only a small, controlled amount is drawn, and it varies by practitioner and treatment area  it is not comparable in volume to blood donation.</p>
      <h3>What are the disadvantages of Hijama?</h3>
      <p>Risks include bruising, fatigue, and  if hygiene standards aren’t followed  infection or bloodborne disease. This is why treatment from a trained, certified practitioner matters.</p>
      <h3>How is hijama different from cupping?</h3>
      <p>Hijama refers specifically to wet cupping, which involves suction plus small incisions. Cupping is a broader term that also includes dry cupping, which uses suction only.</p>
      <h3>Who should avoid Hijama?</h3>
      <p>Pregnant women, people with bleeding disorders or anaemia, those on blood‑thinning medication, and people with certain heart conditions or uncontrolled diabetes should seek medical advice first.</p>
      <h3>How do I get started?</h3>
      <p>If you want to train, apply for the Hijama course. If you want treatment, book a session with a certified Hijama Nation practitioner.</p>
    `,
  ...
  // ============================================================
  {
    ...
    content: `
      ...
      <h2>Understanding the Term "Hijama Cupping"</h2>
      <p>"Cupping" on its own is a broad category, and Hijama sits within it as a specific method. When people search "what is Hijama cupping," they're usually looking for clarity on how this particular form relates to cupping more generally  and the short answer is that Hijama cupping and wet cupping are the same thing.</p>

      <h3>Cupping as the Parent Category</h3>
      <p>Cupping therapy includes several distinct methods:</p>
      <ul>
        <li><strong>Dry cupping</strong>  suction only, with no incisions made to the skin.</li>
        <li><strong>Fire cupping</strong>  a traditional method that uses heat (usually a flame) to remove oxygen from the cup and create suction, rather than a mechanical pump.</li>
        <li><strong>Wet cupping (Hijama)</strong>  suction combined with small, superficial incisions to draw a controlled amount of blood.</li>
      </ul>
      <p>Each method shares the same basic principle  applying a vacuum to the skin's surface  but differs in technique, purpose, and the level of training required to perform it safely.</p>

      <h3>Why Two Names Exist for the Same Practice</h3>
      <p>"Hijama" is the Arabic term rooted in Prophetic medicine and Islamic tradition, while "wet cupping" is the descriptive term more commonly used in medical, clinical, and Western wellness contexts. Both refer to the exact same procedure. You'll often see medical research use "wet cupping," while religious and cultural sources use "Hijama"  which is why understanding this overlap matters when you're trying to piece together information from different types of sources.</p>

      <h2>How Hijama Cupping Works (The Procedure)</h2>
      <p>Understanding the term is only half the picture  knowing what actually happens during a session is what most people searching this phrase really want to know. A typical Hijama cupping session follows a structured sequence.</p>

      <h3>Step 1  Screening and Consultation</h3>
      <p>Before any cups are applied, a properly trained practitioner will ask about your medical history. This includes checking for conditions like pregnancy, anaemia, bleeding disorders, or the use of blood-thinning medication  all of which affect whether Hijama is appropriate for you. This step is non-negotiable in a safe, professional setting.</p>

      <h3>Step 2  Cup Placement</h3>
      <p>Sterile cups are applied to specific points on the body. In traditional practice, these often correspond to recognised Sunnah points, though a practitioner may also select points based on the area of discomfort. The cups create a vacuum that draws the skin upward, increasing blood flow to the surface.</p>

      <h3>Step 3  Superficial Incisions</h3>
      <p>Once the skin has been drawn up by the suction, the practitioner makes small, shallow incisions. These are surface-level only  not deep cuts  and are designed purely to allow a small amount of blood to be released.</p>

      <h3>Step 4  Blood Drawing</h3>
      <p>The cup is reapplied over the incision site, and a small, controlled quantity of blood is drawn into the cup. This amount varies depending on the practitioner, the treatment area, and the number of points being treated, but it is not comparable in volume to blood donation  a common misconception.</p>

      <h3>Step 5  Aftercare</h3>
      <p>Once the session is complete, the treated area is cleaned and dressed, and the client is given guidance on rest, hydration, and wound care over the following days. Aftercare is a key part of the process and shouldn't be treated as an afterthought.</p>

      <h2>What Hijama Cupping Is Used For</h2>
      <p>People turn to Hijama cupping for a mix of physical and spiritual reasons, and it helps to be clear about which is which.</p>

      <h3>Traditionally Reported Reasons</h3>
      <p>Many clients seek Hijama for pain relief, improved circulation, reduced fatigue, general wellbeing, and as a way of reviving a Sunnah practice with spiritual intention. These are widely reported experiences passed down through tradition and personal testimony.</p>

      <h3>Areas With Some Scientific Interest</h3>
      <p>A small body of research has looked into cupping's effects on musculoskeletal pain and certain inflammatory markers, though the evidence remains limited and mixed. It's important that this is communicated honestly  Hijama cupping should never be presented as a guaranteed cure for any medical condition. Responsible sources separate what's traditionally believed from what current evidence actually supports.</p>

      <h3>Common Conditions People Associate With Hijama</h3>
      <p>Chronic back pain, migraines, joint stiffness, general fatigue, stress, and sports-related injuries are among the most common reasons people search for and book Hijama sessions. Each of these deserves its own honest, evidence-aware explanation rather than a blanket claim of effectiveness.</p>

      <h2>Is Hijama Cupping Safe?</h2>
      <p>Safety is one of the most searched concerns around this topic, and it deserves a direct answer: Hijama cupping is safe when performed by a properly trained practitioner using sterile, single-use equipment.</p>

      <h3>What Can Go Wrong Without Proper Hygiene</h3>
      <p>When Hijama is performed by an untrained person, or with reused or poorly sterilised equipment, risks increase significantly. These include:</p>
      <ul>
        <li>Infection at the incision site</li>
        <li>Bruising beyond what's typically expected</li>
        <li>Skin burns (more commonly linked to fire cupping when not done carefully)</li>
        <li>In serious cases, transmission of bloodborne disease</li>
      </ul>
      <p>This is precisely why sterilisation standards and practitioner training aren't optional details  they're the dividing line between a safe wellness session and a genuine health risk.</p>

      <h3>Who Should Avoid Hijama Cupping</h3>
      <p>Certain people should not undergo Hijama without first speaking to a doctor, including:</p>
      <ul>
        <li>Pregnant women</li>
        <li>People with anaemia or bleeding disorders</li>
        <li>Those taking blood-thinning medication</li>
        <li>People with uncontrolled diabetes or certain heart conditions</li>
        <li>Anyone with an active skin infection at the treatment site</li>
      </ul>
      <p>A responsible practitioner will always screen for these factors before beginning treatment, rather than proceeding based on request alone.</p>

      <h2>Hijama Cupping and Its Place in Islamic Tradition</h2>
      <p>Hijama cupping carries particular significance within Islamic tradition as part of Prophetic medicine (Tibb an-Nabawi). It is associated with specific Sunnah days  traditionally the 17th, 19th, and 21st of the Islamic lunar month  and with defined points on the body referred to as Sunnah points.</p>
      <p>For many practitioners and clients, this isn't simply a physical treatment. It's viewed as an act of reviving a tradition attributed to the Prophet ﷺ, carried out with intention and care. That said, it's worth keeping the religious and medical framing distinct: the timing and body points are a matter of tradition and personal practice, while the question of whether Hijama is medically appropriate for a given person remains a separate, medical consideration.</p>

      <h2>Hijama Cupping vs Other Terms You Might See</h2>
      <p>Because this topic sits at the intersection of medical, cultural, and religious language, it's easy to come across overlapping or confusing terminology. Here's a quick reference:</p>
      <table>
        <thead>
          <tr><th>Term</th><th>What It Means</th></tr>
        </thead>
        <tbody>
          <tr><td><strong>Hijama</strong></td><td>Traditional Arabic term for wet cupping, rooted in Prophetic medicine</td></tr>
          <tr><td><strong>Wet cupping</strong></td><td>Medical/clinical term for the same practice as Hijama</td></tr>
          <tr><td><strong>Hijama cupping</strong></td><td>Commonly used phrase referring to the same practice, often in casual search queries</td></tr>
          <tr><td><strong>Dry cupping</strong></td><td>Suction only, no incisions  a different method entirely</td></tr>
          <tr><td><strong>Cupping therapy</strong></td><td>The broad umbrella term covering wet, dry, and fire cupping methods</td></tr>
        </tbody>
      </table>
      <p>Recognising these terms helps you make sense of results whether you're reading a medical study, a religious explainer, or a clinic's service page.</p>

      <h2>Getting Started With Hijama Cupping</h2>
      <p>Once you understand what Hijama cupping is, the natural next step is deciding how you want to engage with it  as a client seeking treatment, or as someone interested in training to deliver it to others.</p>
      <p>If you're looking to experience it firsthand, treatment should always begin with proper screening and be carried out using sterile, single-use equipment by a certified practitioner. If you're drawn to learning the practice itself  whether as a Sunnah-based calling or a potential career  proper certification training covering hygiene, technique, and safety is essential before treating anyone.</p>
      <p>Hijama Nation offers both pathways: certified training for those who want to become practitioners, and professional treatment sessions for those who want to experience Hijama safely and respectfully.</p>

      <h2>Frequently Asked Questions</h2>
      <h3>Is Hijama cupping the same as wet cupping?</h3>
      <p>Yes. Hijama cupping and wet cupping refer to the exact same practice  suction combined with small, superficial incisions. "Hijama" is the traditional Arabic term, while "wet cupping" is the term more commonly used in medical and clinical contexts.</p>

      <h3>What is the difference between Hijama cupping and normal cupping?</h3>
      <p>"Normal cupping" usually refers to dry cupping, which uses suction only with no incisions. Hijama cupping goes a step further by making small incisions to draw a controlled amount of blood.</p>

      <h3>Does Hijama cupping hurt?</h3>
      <p>Most people describe mild discomfort  a pulling sensation from the suction and a brief scratching sensation from the incisions  followed by light soreness similar to a bruise afterwards.</p>

      <h3>How much blood is drawn during Hijama cupping?</h3>
      <p>Only a small, controlled amount, which varies by practitioner and treatment area. It is not comparable in volume to blood donation.</p>

      <h3>Is Hijama cupping safe?</h3>
      <p>Yes, when performed by a trained, certified practitioner using sterile, single-use equipment. Risks such as infection or bruising increase significantly when hygiene standards aren't followed.</p>

      <h3>Who should avoid Hijama cupping?</h3>
      <p>Pregnant women, people with bleeding disorders or anaemia, those on blood-thinning medication, and people with certain heart conditions or uncontrolled diabetes should speak to a doctor before booking.</p>

      <h3>How long does a Hijama cupping session take?</h3>
      <p>Most sessions take between 30 and 60 minutes, depending on the number of points treated and the client's individual needs.</p>
  ...
  // ============================================================
  {
    ...
    content: `
      ...
      <h2>The Core Function of Hijama Cups</h2>
      <p>At their core, Hijama cups exist to do one job: create suction on the skin. This suction draws blood to the surface, which serves two purposes in a wet cupping session  it makes the area easier to work with once small incisions are made, and it's believed within tradition to help draw out stagnant or "toxic" blood from beneath the skin.</p>

      <h3>Creating the Vacuum</h3>
      <p>Suction is created either manually, using a hand pump attached to the cup, or with pre-vacuumed disposable cups that create suction the moment they're placed. Manual pump cups allow a practitioner to control pressure precisely, which matters for sensitive areas or first-time clients.</p>

      <h3>Preparing the Skin for Incisions</h3>
      <p>Once suction has drawn the skin upward for a few minutes, the cup is removed and small, superficial incisions are made. The cup is then reapplied to draw out a small, controlled amount of blood. Without the initial suction step, incisions alone wouldn't achieve the same effect  the cup is what makes the process work as intended.</p>

      <h2>Types of Hijama Cups</h2>
      <p>Not all cups used in cupping therapy are the same, and the type used affects both hygiene and outcome.</p>

      <h3>Disposable Plastic Cups</h3>
      <p>Most modern, hygiene-focused clinics use single-use plastic cups with a manual pump mechanism. These are discarded after each client, removing any risk of cross-contamination between sessions. This is the standard most reputable practitioners  including certified ones  now follow.</p>

      <h3>Silicone Cups</h3>
      <p>Silicone cups are flexible and often used for massage-style dry cupping rather than wet Hijama, since they're harder to sterilise thoroughly between clients when incisions are involved.</p>

      <h3>Glass Cups (Traditional/Fire Cupping)</h3>
      <p>Glass cups are typically associated with fire cupping, where a flame briefly removes oxygen from inside the cup to create suction before it's placed on the skin. This method is less common in modern Hijama practice due to the higher skill required and the burn risk if not handled carefully.</p>

      <h3>Cup Sizes</h3>
      <p>Cups come in a range of sizes to suit different areas of the body  smaller cups for areas like the head or neck, larger cups for the back or shoulders. A trained practitioner selects cup size based on the treatment area and the client's individual needs.</p>

      <h2>Where Hijama Cups Are Placed</h2>
      <p>Cup placement isn't random. In traditional practice, cups are often applied to recognised Sunnah points on the body, though a practitioner may also choose points based on where a client is experiencing pain or tension.</p>

      <h3>Common Treatment Areas</h3>
      <p>Cups are frequently placed on the upper back, shoulders, neck, and head, though placement varies depending on the reason for treatment  whether that's general wellbeing, a specific area of pain, or Sunnah-based practice.</p>

      <h3>Why Placement Requires Training</h3>
      <p>Placing cups on the wrong area, or too close to sensitive structures like major blood vessels or joints, increases the risk of bruising or complications. This is one of the key reasons Hijama cupping should only be performed by someone with proper certification, not attempted informally.</p>

      <h2>Hygiene and Equipment Standards</h2>
      <p>The equipment used is just as important as the technique behind it. Reused or improperly sterilised cups carry a real risk of infection or, in more serious cases, transmission of bloodborne disease between clients.</p>

      <h3>What Proper Practice Looks Like</h3>
      <ul>
        <li>Single-use, disposable cups and blades wherever possible</li>
        <li>Full sterilisation of any reusable equipment components between every client</li>
        <li>Clean gloves and a hygienic treatment space</li>
        <li>Proper disposal of used equipment after each session</li>
      </ul>

      <h3>What to Ask Before Booking</h3>
      <p>Clients are well within their rights to ask a practitioner about their equipment and hygiene process before booking. A properly trained, certified practitioner will answer this openly and without hesitation  it's a standard part of responsible practice, not an unusual question.</p>

      <h2>Hijama Cups vs Dry Cupping Equipment</h2>
      <p>While the cups used for wet and dry cupping can look similar, the process around them differs.</p>
      <table>
        <thead>
          <tr><th></th><th>Dry Cupping Equipment</th><th>Hijama Cups</th></tr>
        </thead>
        <tbody>
          <tr><td><strong>Suction method</strong></td><td>Pump or fire</td><td>Pump or fire</td></tr>
          <tr><td><strong>Incisions involved</strong></td><td>No</td><td>Yes</td></tr>
          <tr><td><strong>Sterilisation needs</strong></td><td>Basic cleaning</td><td>Strict, single-use standard</td></tr>
          <tr><td><strong>Common use</strong></td><td>Muscle tension, relaxation</td><td>Traditional detox, pain relief, Sunnah practice</td></tr>
        </tbody>
      </table>
      <p>This distinction matters because dry cupping equipment doesn't carry the same infection risk as Hijama cups, since no incisions are made  which is also why Hijama demands a higher standard of practitioner training.</p>

      <h2>Do You Need Special Cups to Learn Hijama?</h2>
      <p>For those considering training as a Hijama practitioner, understanding equipment is a core part of any proper course  not just how to use cups, but how to source, sterilise, and dispose of them correctly. A responsible Hijama course will cover equipment standards in depth before any student moves on to practising technique.</p>

      <h2>Getting Started</h2>
      <p>Understanding what Hijama cups are used for is a small but important piece of the wider picture  alongside procedure, safety, and religious context. If you're considering treatment, ask your practitioner about their equipment standards before booking. If you're considering training, look for a course that treats hygiene and equipment as seriously as technique.</p>
      <p>Hijama Nation follows strict single-use equipment standards across every treatment session, and covers equipment and hygiene protocols thoroughly as part of our certified Hijama course.</p>

      <h2>Frequently Asked Questions</h2>
      <h3>What are Hijama cups made of?</h3>
      <p>Most modern cups are disposable plastic with a manual pump mechanism. Some practitioners use silicone or glass cups, though these are more commonly associated with dry or fire cupping rather than wet Hijama.</p>

      <h3>Are Hijama cups reused between clients?</h3>
      <p>Properly trained practitioners use single-use, disposable cups or fully sterilise reusable components between every client to prevent cross-contamination.</p>

      <h3>How do Hijama cups create suction?</h3>
      <p>Suction is created either manually with a hand pump attached to the cup, with pre-vacuumed disposable cups, or traditionally using fire to briefly remove oxygen from inside a glass cup.</p>

      <h3>Do bigger cups mean a stronger treatment?</h3>
      <p>Not necessarily. Cup size is chosen based on the treatment area and client comfort, not treatment strength. A trained practitioner selects the appropriate size for each area of the body.</p>

      <h3>Can I buy Hijama cups and do it myself at home?</h3>
      <p>This isn't recommended. Hijama involves incisions and carries real hygiene and safety risks if performed without proper training, sterile equipment, and screening for contraindications.</p>

      <h3>Why do some clinics use fire cupping instead of pump cups?</h3>
      <p>Fire cupping is a traditional method some practitioners prefer, though it requires more skill to perform safely and carries a higher risk of burns if not handled carefully. Most modern, hygiene-focused clinics use pump-based disposable cups instead.</p>
...
// ============================================================
// BLOG 5 – Hijama Therapy for Multiple Health Issues (UPDATED WITH CTA)
// ============================================================
{
  id: 5,
  ...
  content: `
    ...
    <div style="background: #f0fdf4; padding: 30px; border-radius: 12px; margin: 20px 0; border-left: 4px solid #1c7c47;">
      <h3 style="margin-top: 0; color: #1a2e1a; font-family: 'Playfair Display', serif;">Ready to Begin Your Journey?</h3>
      <ul style="list-style: none; padding: 0;">
        <li style="margin: 12px 0;">
          <strong>🎯 Free Webinar:</strong> 
          <a href="https://hijama.hijamanation.com/webinar-reg2" target="_blank" rel="noopener noreferrer" style="color: #1c7c47; text-decoration: none; font-weight: 500;">
            Listen to our free webinar and book your interview call now
          </a>
        </li>
        <li style="margin: 12px 0;">
          <strong>📧 Email:</strong> 
          <a href="mailto:info@hijamanation.com" style="color: #1c7c47; text-decoration: none; font-weight: 500;">
            info@hijamanation.com
          </a>
        </li>
        <li style="margin: 12px 0;">
          <strong>🌐 Website:</strong> 
          <a href="https://www.hijamanation.com" target="_blank" rel="noopener noreferrer" style="color: #1c7c47; text-decoration: none; font-weight: 500;">
            www.hijamanation.com
          </a>
        </li>
        <li style="margin: 12px 0;">
          <strong>📱 WhatsApp:</strong> 
          <a href="tel:+447838614062" style="color: #1c7c47; text-decoration: none; font-weight: 500;">
            +44 (0) 7838 614062
          </a>
        </li>
        <li style="margin: 12px 0;">
          <strong>🎓 Other Courses:</strong> 
          <a href="https://www.hijamanationacademy.com/" target="_blank" rel="noopener noreferrer" style="color: #1c7c47; text-decoration: none; font-weight: 500;">
            www.hijamanationacademy.com
          </a>
        </li>
      </ul>
    </div>
